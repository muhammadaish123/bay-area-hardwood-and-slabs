...
export default function Hero() {
  return (
    <section className="relative h-screen min-h-[680px] overflow-hidden md:min-h-0">
      <div className="relative h-full w-full overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="absolute inset-x-0 bottom-10 sm:bottom-8 md:bottom-12">
          <div className="container px-5 pb-4 sm:px-6 sm:pb-8 md:px-0 md:pb-14">
            ...
            <p className="mt-3 max-w-lg text-[15px] leading-relaxed text-paper/85 font-sans normal-case sm:mt-5 sm:text-base md:text-lg">
